 ...
 * international variant of the HTC One X (endeavoru).
 */
public class OnexEndeavoruPhoneInfo extends PhoneInfo {

    public static final String PATH = "/sys/class/leds/button-backlight/"
        + "brightness";

    public static final String NAME = "HTC One X (endeavoru)";
